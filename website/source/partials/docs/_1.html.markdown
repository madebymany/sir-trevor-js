...
Alternatively, grab the following files and include them in your project:
  ...
  * [Sir Trevor JS](https://github.com/madebymany/sir-trevor-js/blob/dist/sir-trevor.js)


And you'll need the following CSS file too:

  * [Sir Trevor](https://github.com/madebymany/sir-trevor-js/blob/dist/sir-trevor.css)
