...
(function ($, _){
  ...
  */
  ...
  var tweet_template = '<div class="tweet"><img src="<%= user.profile_image_url %>" class="tweet-avatar"><div class="tweet-body"><p><a href="http://twitter.com/#!/<%= user.screen_name %>">@<%= user.screen_name %></a></p><p><%= text %><time><%= created_at %></time></p></div></div>';
